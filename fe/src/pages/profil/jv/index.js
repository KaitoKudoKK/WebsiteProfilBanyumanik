...
export default function ProfilJv({ content }) {
    const {
        title,
        visi,
        misi,
    ...
    return (
        <>
            <Head>
                <title>{title || "Profil Padukuhan Banyumanik (Jawa)"}</title>
            ...
            {/* Language switch (tengah) */}
            <div className="w-full bg-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex justify-center py-6">
                        <nav role="tablist" aria-label="Pilih bahasa" className="flex items-center gap-3">
            ...
            <section className="bg-gray-100 py-6">
                <div className="max-w-5xl mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#0F7050] mb-16">Visi lan Misi</h2>
                    <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
                        <h3 className="text-[#1E1E1E] md:text-[21.3pt] px-4 md:px-10 text-xl font-bold mb-4 text-center">Visi</h3>
                        <p className="text-[#1E1E1E] md:text-[17.3pt] px-4 md:px-10 leading-relaxed whitespace-pre-line text-center">
                            {visi}
                        </p>

                        <h3 className="text-[#1E1E1E] md:text-[21.3pt] px-4 md:px-10 text-xl font-bold mb-4 text-center">Misi</h3>
                        <p className="text-[#1E1E1E] md:text-[17.3pt] px-4 md:px-10 leading-relaxed whitespace-pre-line text-center">
                            {misi}
                        </p>
                    </div>
                    ...
                    {kelembagaan?.image ? (
                        <div className="rounded p-6 flex justify-center">
                            <div className="max-w-3xl w-full">
                                ...
                                />
                                {kelembagaan.caption && (
                                    <p className="text-[#1E1E1E] md:text-[16pt] px-4 py-4 md:px-10 leading-relaxed whitespace-pre-line text-center">
                                        {kelembagaan.caption}
                                    </p>
                                )}
                            </div>
                        ...
                        <div className="text-center text-gray-500">Gambar kelembagaan durung diunggah.</div>
                    )}
                </div>
            </section>
            ...
            <section className="bg-white py-12">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#0F7050] mb-4">{batas_wilayah_heading || "Batas Wilayah lan Kondisi Geografis"}</h2>
            ...
            <section className="bg-gray-100 py-12">
                <div className="max-w-5xl mx-auto px-4">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#0F7050] text-center mb-6">{kependudukan?.heading || "Kependudukan"}</h2>
                    {kependudukan?.image ? (
                        ...
                        <div className="text-center text-gray-500">Gambar kependudukan durung diunggah.</div>
                    )}
                </div>
            </section>
...
export async function getStaticProps() {
    const filePath = path.join(process.cwd(), "src", "content", "profil.jv.md");
    let content = {};
    try {
        ...
        console.warn("profil.jv.md not found:", err.message);
    }
