        ...
        <>
            ...
            >
                <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
                    <div className="flex gap-2 text-xs md:text-sm font-medium">
                        <a href="/" className="px-3 py-1 rounded-full bg-[#4B6153] text-white">Indonesia</a>
                        <a href="/jv" className="px-3 py-1 rounded-full bg-[#D3E3D0] text-[#4B6153] hover:bg-[#bcd1ba]">Jawa</a>
            ...
            <section className="py-8 md:py-12 bg-gray-100 px-4 md:px-6">
                <h2 className="text-2xl md:text-3xl font-bold text-green-900 text-center mb-6 md:mb-10">
                    Berita Terbaru Padukuhan Banyumanik
                </h2>
